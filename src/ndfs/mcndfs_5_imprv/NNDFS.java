...
public class NNDFS implements NDFS {
	...
	private final Map<State, Integer> globalCount = new ConcurrentHashMap<State, Integer>();
	private final Map<State, Boolean> globalRed = new ConcurrentHashMap<State, Boolean>();
